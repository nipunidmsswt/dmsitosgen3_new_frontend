...
const ViewRoomBuyingRate = () => {
    const columns = [
        {
            title: 'Operator Group Code',
            field: 'operatorGpCode.code',
            filterPlaceholder: 'Bank Name',
            align: 'left'
        },
        {
            title: 'Season',
            field: 'season.mainSeason',
    ...
    useEffect(() => {
        ...
        // console.log(location.state.rowdata.id);
        dispatch(getRoomBuyingRatesByHotel(location.state.rowdata.id));
    }, [location]);

    useEffect(() => {
        console.log(roomBuyingRateByHotelList);
        setTableData(roomBuyingRateByHotelList);
    }, [roomBuyingRateByHotelList]);
    ...
    const handleClickOpen = (type, data) => {
        if (type === 'VIEW_UPDATE') {
            navigate('/master/roombuyingrate', {
                state: {
                    data: data,
                    mode: 'VIEW_UPDATE'
                }
    ...
    return (
        <div>
            <MainCard title="Hotel Room Buying Details">
...
export default ViewRoomBuyingRate;
