...
function FacilityCounter({ open, mode, handleClose, ownerCode }) {
    ...
    const validationSchema = Yup.object().shape({
        ...
        code: Yup.string()
            .required('Required')
            .test('Unique', 'ServiceOffered Code Already Exists', async function validateValue(value) {
                if (mode === 'INSERT') {
                    try {
