        ...
        <section className="bRecipes">
            <div className="recipes">
                <div className="infos">
                    ...
                    <p>
                        Far far away, behind the word mountains, far from the countries Vakalia and Consonantia, there live the blind texts
                    </p>
                </div>

                <div className="recipe-posts">
                    <RecipePost title="Broccoli Salad With Bacon" src={PicRecipe1} alt="A imagem of a beauty Broccoli Salad With Bacon" />

                    <RecipePost title="Classic Beef Burgers" src={PicRecipe2} alt="A imagem of a beauty Classic Beef Burgers" />

                    <RecipePost title="Classic Potato Salad" src={PicRecipe3} alt="A imagem of a beauty Classic Potato Salad" />
